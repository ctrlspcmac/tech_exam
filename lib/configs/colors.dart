...
class AppColors {
  static const Color colorSecondary = Color(0xFF2FF29E);
  static const Color colorTertiary = Color(0xFFFFE382);
  static const Color colorPrimary = Color(0xFFFFFFFF);

  static const Color lineColor = Color(0xFFA6A6A6);
  static const Color titleColor = Color(0xFF878787);
  static const Color iconColor = Color(0xFF121B28);
  static const Color iconButtonColor = Color(0xFF5165BF);
  static const Color subTitle = Color(0xFF6B5E5E);
  ...
  static const Color floatbar = Color(0xFFFFAD84);
